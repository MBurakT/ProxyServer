 ...
 * clients and this includes the HTML markup, images, css and js files associated with each web page.
 * 
...
public class Proxy implements Runnable{
	...
	private void closeServer(){
		 ...
		 * @param urlString URL of web page to cache
...
//				System.out.println("Enter new site to block, or type \"blocked\" to see blocked sites, \"cached\" to see cached sites, or \"close\" to close server.");
				System.out.println("Type \"blocked\" to see blocked sites, \"cached\" to see cached sites, or \"close\" to close server.");
